...
const classesData = [
    { id: 'yoga-flow', name: 'Yoga Flow', description: 'Find your inner peace and improve flexibility with our Vinyasa Flow class.', schedule: 'Mon, Wed, Fri - 9:00 AM', category: 'flexibility', image: "yoga.jpg" },
    { id: 'crossfit-intensity', name: 'CrossFit Intensity', description: 'High-intensity functional movements to build strength and endurance.', schedule: 'Tue, Thu - 6:00 PM', category: 'strength', image: "crossfit.png" },
    { id: 'spin-mania', name: 'Spin Mania', description: 'Ride through virtual terrains in this high-energy indoor cycling class.', schedule: 'Mon, Wed - 7:00 AM', category: 'cardio', image: "spinmania.png" },
    { id: 'strength-circuit', name: 'Strength Circuit', description: 'Full-body strength training using various equipment and bodyweight exercises.', schedule: 'Tue, Thu - 10:00 AM', category: 'strength', image: "strength.png" },
    { id: 'zumba-dance', name: 'Zumba Dance Party', description: 'Dance your way to fitness with this exhilarating and fun Latin-inspired workout.', schedule: 'Fri - 5:00 PM', category: 'dance', image: "zumba.png" },
    { id: 'hiit-blast', name: 'HIIT Blast', description: 'Short, intense bursts of exercise followed by brief recovery periods for maximum fat burn.', schedule: 'Mon, Thu - 12:00 PM', category: 'cardio', image: "hiitblast.png" },
];
...
const testimonialsData = [
    { quote: "Alfa Fitness has transformed my life! The trainers are amazing and the classes are so motivating. Highly recommend!", name: "Saurabh" },
    { quote: "Never thought I'd enjoy working out, but Alfa Fitness made it fun. The community here is incredibly supportive.", name: "Anil" },
    { quote: "The best gym experience I've had. Clean facilities, diverse classes, and knowledgeable trainers. Truly a top-notch place!", name: "Vishal" },
    { quote: "I've achieved goals I never thought possible. Alfa Fitness provides everything you need for a successful fitness journey.", name: "Amit" },
];
